...
function initAdmin(socket) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].get('/admin/orders', {
    ...
    orders = res.data;
    console.log(orders); //admin request all the dat anad populate it to the orders and display it ot front page using the innerhtml
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      //recieves arrayas the map runs a loop over all
...
function updateCart(prod) {
  // return res
  axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/update-cart', prod).then(function (res) {
    console.log(res);
...
addToCart.forEach(function (btn) {
  //recieves the info saved in json format
...
function updateStatus(order) {
  //These are for the prder traking page wherein we change color of various statuses
...
var adminAreaPath = window.location.pathname; //get the url opened like /admin/status
if (adminAreaPath.includes('admin')) {
  //if it is the admin page then only this works
  (0,_admin__WEBPACK_IMPORTED_MODULE_2__.initAdmin)(socket); //pass socket to admin page to be used 
  socket.emit('join', 'adminRoom');
}
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //to copy the order data we use ... in js
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_0__.loadStripe)('pk_test_51Np89YSBTyMHipGBPuRg8z0ptBJJ5ss9R8GmlL7dqd5GLrr4bElgTq7Aa2Epk4FGdLs2JNKObi237SWK5qpq4Txg00daft4FTt');
        case 3:
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkswanands"] = self["webpackChunkswanands"] || [];
